...
**`05-aap-deployment-guide.md`** — How to apply the CaC YAML generated by `cac-author` to a live AAP controller. Covers prerequisites, the controller inventory file, authentication, the `infra.controller_configuration dispatch` playbook, dry-run validation, rollback, per-environment deployments, and CI/CD integration.
...
- **Deploying CaC to AAP?** → `docs/05-aap-deployment-guide.md`
